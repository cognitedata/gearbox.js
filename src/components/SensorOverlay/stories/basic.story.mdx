...
const linksMap = { [8681821313339919]: true };
...
<Preview>
  <Story name="With sticky tooltips">
    <SensorOverlay timeseriesIds={[8681821313339919]} stickyMap={stickyMap}><CustomizedDiv/></SensorOverlay>
  </Story>
</Preview>
          ...
          onClick={() =>
            this.setState({
              timeseriesIds: [
                ...
                timeseriesIds[this.state.counter],
              ],
