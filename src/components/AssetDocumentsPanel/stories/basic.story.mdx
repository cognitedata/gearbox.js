...
import { decorators, docTypes, handleAssetFilesLoaded, customStyle, ComponentProps } from './helper';

<Meta title="Components/AssetDocumentsPanel" decorators={decorators} />
...
<Preview>
  <Story name="Basic usage">
    <AssetDocumentsPanel assetId={4650652196144007} documentTitleField={'DOC_TITLE'} />
  </Story>
</Preview>
...
Types that come from `@cognite/gearbox`:
