...
This interface defines the configurations for annotation in `TimeseriesChart`component.
...
<Preview>
  <Story name="Context chart" decorators={[zoomableClientDecorator]}>
    <TimeseriesChart
      timeseriesIds={[123]}
...
<Preview>
  <Story name="Live update" decorators={[zoomableClientDecorator]}>
    <TimeseriesChart
      ...
      ySubDomains={ysubDomainsForLiveUpdate}
    />
  </Story>
</Preview>
...
<Preview>
  <Story name="Define Y-axis Subdomain" >
    <TimeseriesChart
      timeseriesIds={[123]}
      ySubDomains = {ySubDomains}
    />
  </Story>
</Preview>

### Define Y-axis Subdomain For Series
...
<Preview>
  <Story name="Define Y-axis Subdomain For Series" >
    <TimeseriesChart
      series={seriesWithCustomYdomain} 
    />
  </Story>
</Preview>
