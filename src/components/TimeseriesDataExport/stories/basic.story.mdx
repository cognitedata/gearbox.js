...
<Preview>
  <Story name="Basic usage with timeseriesExternalId" >
    <TimeseriesChartExportWrapper
      timeseriesExternalId = {['TAM_TGM_GAS_LIFT_A_ FY_31204_STR1_CALIB_TT']}
      granularity={'2m'}
      defaultTimeRange={[1567321800000, 1567408200000]}
    />
  </Story>
...
const labelFormatter: CSVLabelFormatter = (ts: GetTimeSeriesMetadataDTO) => ts.name || \`timeserie-${ts.id}\`;
```
<Preview>
